<?php
/**
 * Spacious_Toolkit Elementor Block 1 Element
 *
 * @author   ThemeGrill
 * @category Elements
...
class SPT_BLOCK_1 extends Widget_Base {
	...
	/**
	 * Retrieve SPT_BLOCK_1 widget title.
	 *
	 * @access public
	 *
	...
	public function get_title() {
		return esc_html__( 'Block Posts 1', 'spacious-tookit' );
	}
	...
	/**
	 * Render SPT_BLOCK_1 widget output on the frontend.
	 *
	...
	protected function render() {
		spacious_get_template( 'content-widget-block-1.php', $args = array( 'instance' => $this ) );
	}
