<?php
/**
 * Block 1 Widget controls
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/controls/content-widget-block-1.php.
 *
...
$instance->start_controls_section(
	'section_block_1_title',
	array(
		'label' => esc_html__( 'Block Title', 'spacious-toolkit' ),
	)
);
...
$instance->add_control(
	...
	array(
		...
		'default' => esc_html__( 'Block posts 1' ),
	)
);
